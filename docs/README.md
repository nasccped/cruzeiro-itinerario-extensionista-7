...
- [text-models]\: modelos de texto usados para agilizar tarefas
  (encaminhamento de e-mail, etc)
- [thirdparty](./thirdparty)[^thirdparty]\: documentos
  fornecidos pela própria universidade afim de contribuir com o
  desenvolvimento do projeto

[entity-docs]: ./entity-docs/00-index.md
[milestones]: ./milestones/00-index.md
[text-models]: ./text-models/00-index.md

[^thirdparty]: _"ThirdParty"_, do inglês: "aquilo que é
  oriundo de terceiros"
